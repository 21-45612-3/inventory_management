...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-expand-lg fixed-top" style="background: linear-gradient(0deg, #C8DBED 35%, #9BBBDA 100%);">
        ...
        <section>
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5">
                    <div class="col-lg-12">
                        <h1 class="d-flex justify-content-center align-items-center" style="margin-top: 400px;">Inventory Management System</h1>
                    </div>
                </div>
            </div>
        </section>
